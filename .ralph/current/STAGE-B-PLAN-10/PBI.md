...
updated_at: 2026-05-27T13:43:03+00:00
depends_on: ["STAGE-B-PLAN-03"]
---

# Implement Plan: ralph-cancel + ralph-promote + ralph-triage skills

Execute the canonical implementation plan at:
`docs/superpowers/plans/2026-05-24-10-supervisor-skills.md`
...
- PR opened against `main` from `ralph/STAGE-B-PLAN-10`
