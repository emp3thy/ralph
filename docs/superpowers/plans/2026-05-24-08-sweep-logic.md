...
- [ ] 1. Confirm Plans 5 and 7 are merged. Run:
  ```
...
- [ ] 2. Verify `pyproject.toml` already covers the new tree. Open `pyproject.toml` and confirm exactly:
...
- [ ] 3. Confirm `RALPH_ADO_AUTHOR_EMAIL` is documented. Open `docs/superpowers/plans/2026-05-24-00-orchestrator.md` and search for `RALPH_ADO_AUTHOR_EMAIL`. If it is NOT listed in the "Environment variables" table, append this row at the bottom of the table:
  ```
...
- [ ] 4. Create `ralph_executor/sweep/__init__.py` containing exactly:
  ```python
...
- [ ] 5. Create `ralph_executor/sweep/types.py` containing exactly:
  ```python
...
- [ ] 6. Create `tests/executor/sweep/__init__.py` containing exactly:
  ```python
  """Empty package marker."""
  ```

- [ ] 7. Run the toolchain to confirm the scaffold parses:
  ```
